...
Login:    <input type="text" pattern="^[a-zA-Z0-9]{3,15}$" title="Username must be between 3 and 15 characters and contain only alphanumeric characters" name="uname" required readonly="readonly" value= <?php echo "$user_check"; ?> ><br>

Password: <input type="password" pattern="^[a-zA-Z0-9*_$]{8,20}$" title="Password must be between 8 and 20 characters and contain alphanumeric or *,_,$" name="pwd" required value= <?php echo "$pass"; ?> >
</fieldset>
<fieldset>
<legend>Personal Details</legend>
Name:              <input type="text" name="aname" pattern="^[a-zA-z]{3,30}" title="Enter a valid name" required value= <?php echo "$name"; ?> ><br>

Age:               <input type="number" name="age" min=1 max=200 required value= <?php echo "$age"; ?> ><br>

Experience:        <input type="number" name="exp" min=0 max=99 required value= <?php echo "$exp"; ?> ><br>

Institution:       <input type="text" name="insti" pattern="^[a-zA-z]{3,50}" title="Enter a valid name" required value= <?php echo "$insti"; ?> ><br>
 
Phone Number:      <input type="text" name="phone" pattern="^[0-9]{6,10}" title="Enter a valid phone number" required value= <?php echo "$ph"; ?> ><br>

Email id:          <input type="email" name="email" maxlength=50 required value= <?php echo "$em"; ?> ><br>

Subject Expertise: <input type="text" name="domain"  title="Enter a valid field" required value=<?php echo "$sub"; ?> ><br>
</fieldset>
